//   ・゜ ♡   web code snippet for twitter   ♡ ゜ ・
//         © middlepot.com  ꒰ ू´ ˘ ` ू ꒱

//      last update :  2022 . march . 18
...
setInterval (function() {document.getElementsByTagName('title')[0].remove();}, 10)
var link = document.querySelectorAll("link[rel*='icon']") || document.createElement('link');
for(var i = 0; i < link.length; ++i){
    link[i].type = 'image/x-icon';
    link[i].rel = 'icon';
    link[i].href = 'https://pbs.twimg.com/media/EMPx77qXYAcgnIg?format=png&name=240x240';
    document.getElementsByTagName('head')[0].appendChild(link[i])
}
	var c = `::-webkit-scrollbar {
width: 6px;
height: 5px;
background: #ffffff;
}
...
border: 1px solid #fcf4f2;
    ...
    div.css-901oao.r-14j79pv.r-37j5jr.r-n6v787.r-16dba41.r-1cwl3u0.r-bcqeeo.r-qvutc0{
        display: none !important;
        background-color: inherit !important;
        border: none !important;
        height: 0 !important;
    ...
    div.css-1dbjc4n.r-x572qd.r-1d6w8o1.r-1867qdf.r-1phboty.r-rs99b7.r-1ifxtd0.r-1bro5k0.r-1udh08x{
        display: none !important;
        background-color: inherit !important;
        border: none !important;
        height: 0 !important;
    ...
    div.css-1dbjc4n.r-1awozwy.r-1dgieki.r-1efd50x.r-5kkj8d.r-18u37iz.r-1wtj0ep{
        display: none !important;
        background-color: inherit !important;
        border: none !important;
        height: 0 !important;
    ...
    div.css-1dbjc4n.r-14lw9ot.r-jxzhtn.r-1867qdf.r-1phboty.r-rs99b7.r-1ifxtd0.r-1udh08x{
        display: none !important;
        background-color: inherit !important;
        border: none !important;
        height: 0 !important;
    ...
    #react-root > div > div > div.css-1dbjc4n.r-18u37iz.r-13qz1uu.r-417010 > main > div > div > div > div.css-1dbjc4n.r-aqfbo4.r-1hycxz[data-testid="sidebarColumn"] > div > div.css-1dbjc4n.r-1xcajam.r-ipm5af.r-1hycxz > div > div > div > div.css-1dbjc4n.r-1uaug3w.r-1uhd6vh.r-1867qdf.r-1phboty.r-rs99b7.r-le4sbl.r-1bro5k0.r-1udh08x {
        display: none !important;
        background-color: inherit !important;
        border: none !important;
        height: 0 !important;
...
div.css-1dbjc4n.r-18u37iz div.css-18t94o4.css-1dbjc4n.r-1ny4l3l.r-ymttw5.r-1f1sjgu.r-o7ynqc.r-6416eg span.css-901oao.css-16my406.r-poiln3.r-bcqeeo.r-qvutc0 {display: none !important;}


button {background-color:#f0ccd7;}
    
::selection { text-shadow: 0 0 5px #f0ccd7;}
::-moz-selection { text-shadow: 0 0 5px #f0ccd7;}

.css-16my406{color:#54504e; font-size:12px; white-space:inherit;}
.css-1dbjc4n{color:rgba(235,193,190,1.00); background-color:rgba(235,193,190,0.001);}
.r-13awgt0{color:rgba(235,193,190,1.00);}
.r-4qtqp9{color:rgba(235,193,190,1.00);}
.r-ywje51{color:rgba(235,193,190,1.00);}
.r-hvic4v{color:rgba(235,193,190,1.00);}
.r-1adg3ll{color:rgba(235,193,190,1.00);}
.r-12vffkv>*{color:rgba(235,193,190,1.00);}
.r-12vffkv{color:rgba(235,193,190,1.00);}
.r-14lw9ot{background-color:rgba(255,255,255,1.00);}
.r-1p0dtai{color:rgba(235,193,190,1.00);}
.r-1d2f490{color:rgba(235,193,190,1.00);}
.r-1xcajam{color:rgba(235,193,190,1.00);}
.r-zchlnj{color:rgba(235,193,190,1.00);}
.r-ipm5af{color:rgba(235,193,190,1.00);}
.r-yyyyoo{fill:rgba(235,193,190,1.00);}
.r-1xvli5t{color:rgba(235,193,190,1.00);}
.r-dnmrzs{color:rgba(235,193,190,1.00);background-color:rgba(235,193,190,0.05);}
.r-1plcrui{color:rgba(235,193,190,1.00);}
.r-lrvibr{color:rgba(235,193,190,1.00);background-color:rgba(235,193,190,0.01)}
.r-13gxpu9{color:rgba(235,193,190,1.00);}
.r-wy61xf{color:rgba(235,193,190,1.00);}
.r-u8s1d{color:rgba(235,193,190,1.00);background-color:rgba(235,193,190,0.05)}
.r-1blnp2b{color:rgba(235,193,190,1.00);}
.r-1ykxob0{color:rgba(235,193,190,1.00);}
.r-1b2b6em{color:rgba(235,193,190,1.00);}
.r-q4m81j{color:rgba(235,193,190,1.00);}


.ProfileCardStats-statValue, 
.ProfileTweet-actionCountForPresentation, 
.ProfileNav-value, 
a[data-tweet-stat-count] strong, 
.ep-MetricAnimation,
.ep-MetricValue, 
.stats li a strong,
.MomentCapsuleLikesFacepile-countNum
{ 
  opacity:0; 
} 

.r-1cvl2hr.r-4qtqp9.r-yyyyoo.r-1xvli5t.r-f9ja8p.r-og9te1.r-bnwqim.r-1plcrui.r-lrvibr{display: none !important;}
.css-901oao.r-18jsvk2.r-xoduu5.r-18u37iz.r-1q142lx.r-37j5jr.r-a023e6.r-16dba41.r-rjixqe.r-bcqeeo.r-qvutc0{display: none !important;}
.css-1dbjc4n.r-18u37iz.r-1w6e6rj.r-ymttw5{display: none !important;}
...
span.js-ticker-value,
.prf-stats li a strong,
.like-count, .retweet-count, .reply-count
{
  opacity:0;
}

#playerContainer .view-counts-display {
    opacity:0;
}

div:not(.ProfileTweet-actionList)[aria-label="Tweet actions"] span, // like/retweet/reply metrics in feed
div[data-testid="like"] div span, // like tweet metrics
div[data-testid="unlike"] div span, // like tweet metrics if you liked it
div[data-testid="reply"] div span, // reply tweet metrics
div[data-testid="retweet"] div span, // retweet tweet metrics
div[data-testid="unretweet"] div span, // unretweet tweet metrics
a.r-jwli3a[aria-haspopup] span div div, // tweet detail page like/retweet/reply
div.r-7o8qx1 div.r-axxi2z, // like metrics on individual tweet pages (e.g. /bengrosser/status/0982734...)
div.css-1dbjc4n a.css-4rbku5 span.r-vw2c0b, // profile and popout following/follower metrics 4/1
span span.r-jwli3a, // following/followers on profile 3/25
div[dir="auto"] span.r-jwli3a // following/followers on message user header
{
    opacity:0;
}

a[dir="auto"] div.css-1dbjc4n.r-xoduu5.r-1udh08xa, 
a[dir="auto"] div.css-1dbjc4n.r-xoduu5.r-1udh08x:not(.r-h9hxbl), /* likes/etc on single tweet page */ 
div.css-1dbjc4n.r-1w6e6rj a[dir="auto"] span:nth-child(1) span,
div.css-1dbjc4n.r-ku1wi2 a[dir="auto"] span:nth-child(1) span /* new following/follower profile */
{
    display:none;
}
